const Button = () => {
  return (
    <div className="overflow-x-visible relative w-14 h-14 overflow-y-clip group text-center">
      <div className="flex justify-center items-center w-10 h-10 rounded-full bg-yellow-300 transition-all duration-300 absolute top-0 group-hover:scale-[.60] group-hover:origin-top text-white">
        <svg
          width="800px"
          height="800px"
          viewBox="0 0 24 24"
      ...
      <div className="absolute text-white font-bold -bottom-14 left-1/2 text-sm text-center whitespace-nowrap transition-all duration-300 transform -translate-x-1/2 group-hover:bottom-0">
        Read Me
      </div>
    </div>
  );
